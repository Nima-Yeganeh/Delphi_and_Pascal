...
uses
  ...
  // indy:
  ,IdGlobal, IdContext, IdCustomHTTPServer, IdHTTPServer, IdHTTPWebBrokerBridge
  ,IdWinsock2, IdStreamVCL
  // andremussche:
  ,amdws.IdIOHandlerWebsocket
  ,amdws.IdServerIOHandlerWebsocket
  ,amdws.IdServerSocketIOHandling
  ,amdws.IdServerWebsocketContext
  ,amdws.IdServerWebsocketHandling
;
...
type
  ...
  protected
    function WebSocketCommandGet(AContext: TIdContext; ARequestInfo: TIdHTTPRequestInfo; AResponseInfo:
    ...
    procedure WebsocketUpgradeRequest(const AContext: TIdServerWSContext; ARequestInfo: TIdHTTPRequestInfo; var Accept:
      boolean); virtual;
    procedure WebsocketChannelRequest(const AContext: TIdServerWSContext; var aType: TWSDataType; const aStrmRequest,
      aStrmResponse: TMemoryStream); virtual;
  public
...
function TIdWebsocketServer.WebSocketCommandGet(AContext: TIdContext; ARequestInfo: TIdHTTPRequestInfo; AResponseInfo:
  TIdHTTPResponseInfo): boolean;
begin
...
procedure TIdWebsocketServer.DoCommandGet(AContext: TIdContext; ARequestInfo: TIdHTTPRequestInfo; AResponseInfo:
  TIdHTTPResponseInfo);
begin
...
begin
  ...
  try
    ...
    begin
      ...
      if ctx.IOHandler.IsWebsocket and not ctx.IsSocketIO then
...
procedure TIdWebsocketServer.WebsocketUpgradeRequest(const AContext: TIdServerWSContext; ARequestInfo:
  TIdHTTPRequestInfo; var Accept: boolean);
begin
  Accept := True;
end;

procedure TIdWebsocketServer.WebsocketChannelRequest(const AContext: TIdServerWSContext; var aType: TWSDataType; const
  aStrmRequest, aStrmResponse: TMemoryStream);
var
  s: string;
begin
