...
uses
  superobject
  ,amdws.IdSocketIOHandling, amdws.IdIOHandlerWebsocket
  ,amdws.IdWebsocketServer, amdws.IdHTTPWebsocketClient
;
...
begin
  ...
  server.SocketIO.OnEvent(C_CLIENT_EVENT,
    procedure(const ASocket: ISocketIOContext; const aArgument: ISuperArray; const aCallback: ISocketIOCallback)
    begin
