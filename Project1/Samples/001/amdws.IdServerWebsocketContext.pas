unit amdws.IdServerWebsocketContext;
...
uses
  Types, SysUtils, Classes, StrUtils
  // indy:
  ,IdContext, IdCustomTCPServer, IdCustomHTTPServer
  // andremussche:
  ,amdws.IdServerBaseHandling, amdws.IdServerSocketIOHandling, amdws.IdIOHandlerWebsocket
;

type
  TIdServerWSContext = class;

  TWebSocketUpgradeEvent = procedure(const AContext: TIdServerWSContext; ARequestInfo: TIdHTTPRequestInfo; var Accept:
    boolean) of object;

  TWebsocketChannelRequest = procedure(const AContext: TIdServerWSContext; var aType: TWSDataType; const strmRequest,
    strmResponse: TMemoryStream) of object;
