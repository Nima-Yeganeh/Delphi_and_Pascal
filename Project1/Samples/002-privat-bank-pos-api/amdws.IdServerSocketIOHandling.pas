unit amdws.IdServerSocketIOHandling;
...
uses
  Types, SysUtils, Classes, Generics.Collections, StrUtils
  // indy:
  ,IdException, IdContext, IdCustomTCPServer
  // json:
  {$IFDEF SUPEROBJECT}
  ,superobject
  {$ENDIF}
  // andremussche:
  ,amdws.IdServerBaseHandling, amdws.IdSocketIOHandling
;
...
type
  ...
  public
    function SendToAll(const aMessage: string; const aCallback: TSocketIOMsgJSON = nil; const aOnError: TSocketIOError =
      nil): Integer;
    ...
    {$IFDEF SUPEROBJECT}
    function EmitEventToAll(const aEventName: string; const aData: ISuperObject; const aCallback: TSocketIOMsgJSON = nil;
      const aOnError: TSocketIOError = nil): Integer; overload;
    procedure EmitEventTo(const aContext: TIdServerContext; const aEventName: string; const aData: ISuperObject; const
      aCallback: TSocketIOMsgJSON = nil; const aOnError: TSocketIOError = nil); overload;
    procedure EmitEventTo(const aContext: ISocketIOContext; const aEventName: string; const aData: ISuperObject; const
      aCallback: TSocketIOMsgJSON = nil; const aOnError: TSocketIOError = nil); overload;
    {$ENDIF}
  end;
...
{$IFDEF SUPEROBJECT}
procedure TIdServerSocketIOHandling.EmitEventTo(const aContext: ISocketIOContext; const aEventName: string; const aData:
  ISuperObject; const aCallback: TSocketIOMsgJSON; const aOnError: TSocketIOError);
var
  jsonarray: string;
begin
...
procedure TIdServerSocketIOHandling.EmitEventTo(const aContext: TIdServerContext; const aEventName: string; const aData:
  ISuperObject; const aCallback: TSocketIOMsgJSON; const aOnError: TSocketIOError);
var
...
function TIdServerSocketIOHandling.EmitEventToAll(const aEventName: string; const aData: ISuperObject; const aCallback:
  TSocketIOMsgJSON; const aOnError: TSocketIOError): Integer;
begin
...
procedure TIdServerSocketIOHandling.SendTo(const aContext: TIdServerContext; const aMessage: string; const aCallback:
...
function TIdServerSocketIOHandling.SendToAll(const aMessage: string; const aCallback: TSocketIOMsgJSON; const aOnError:
  TSocketIOError): Integer;
var
  context: ISocketIOContext;
begin
  Result := 0;
